...
<table class="table" width="100%" layoutH="50">
	<thead>
		<tr>
			...
			<th width="150px">操作&nbsp&nbsp&nbsp&nbsp<a class="add" href="familycrud!toAddPage.action" target="navTab"><span>【添加】</span></a></th>
		</tr>
	</thead>
	<tbody>
	<% int a = 0; %>
		...
		<tr>
		 <% a++; %>
			...
			<td ><a title="修改" href="familycrud!toUpdatePage.action?ufid=${bigmenu.ufid}" rel="familyedit"  target="navTab" class="btnView">编辑</a>
				<a title="删除" href="familycrud!deleteFamily.action?ufid=${bigmenu.ufid}" target="ajaxTodo" class="btnDel">删除</a></td>
		</tr>
		</s:iterator>
		<tr>
			<td>总人数:</td>
