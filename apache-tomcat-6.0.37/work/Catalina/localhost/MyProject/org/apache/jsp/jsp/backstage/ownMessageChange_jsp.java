...
public final class ownMessageChange_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t<form action=\"/MyProject/servlet/System_updateUser\" method=\"post\" id=\"myForm\"\r\n");
      ...
      out.write("\t\t\t\t\t<td><input type=\"radio\" name=\"sex\" ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${sysSex==1?\"checked='checked'\":\"\" }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write(" value=\"1\"/>男<input\r\n");
      out.write("\t\t\t\t\t\ttype=\"radio\" name=\"sex\" value=\"0\" ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${sysSex==0?\"checked='checked'\":\"\" }", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write(" />女 <label id=\"userNameMsg4\"></label>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\r\n");
      ...
      out.print(session.getAttribute("sysRealName"));
      out.write("\" style=\"width: 300px\" type=\"text\" id=\"realname\" name=\"realName\"/> <label\r\n");
      ...
      out.print(session.getAttribute("sysBirthday"));
      ...
      out.write("\t\t\t\t\t<td><input style=\"width: 300px\" value=\"");
      out.print(session.getAttribute("sysEMail"));
      out.write("\" type=\"text\" id=\"email\" name=\"eMail\" /> <label id=\"userNameMsg7\"></label>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t<td><input style=\"width: 300px\" value=\"");
      out.print(session.getAttribute("sysPhone"));
      out.write("\" type=\"text\" id=\"phone\" name = \"phone\"/> <label id=\"userNameMsg8\"></label>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t\t<td><input style=\"width: 300px\" value=\"");
      out.print(session.getAttribute("sysAddress"));
      out.write("\" type=\"text\" id=\"address\" name=\"address\" /> <label\r\n");
      ...
      out.write("\t\t\t\t\t<td><input style=\"width: 300px\" value=\"");
      out.print(session.getAttribute("sysPostid"));
      out.write("\" type=\"text\" id=\"youbian\" name=\"postid\" /> <label\r\n");
      ...
      out.write("\t</div>\r\n");
      out.write("</body>\r\n");
      out.write("<script src=\"/MyProject/myhtml/My97DatePickerBeta/My97DatePicker/WdatePicker.js\" type=\"text/javascript\"></script>\r\n");
      out.write("\r\n");
      out.write("</html>");
    } catch (Throwable t) {
