...
import java.util.*;
import com.softxm.oa.model.UserInfo;

public final class passNoctie_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\r\n");
      out.write("\t<form method=\"post\" action=\"notice/natice!pass.action\" class=\"pageForm required-validate\" onsubmit=\"return validateCallback(this,navTabAjaxDone)\">\r\n");
      out.write("\t\t<div class=\"pageFormContent nowrap\" layoutH=\"97\">\r\n");
      out.write("\t\t\t<input type=\"hidden\" value=\"");
      out.print(request.getParameter("ebnum"));
      out.write("\" name=\"ebnum\"/>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<dl>\r\n");
      out.write("\t\t\t\t<dt>审核人:</dt>\r\n");
      out.write("\t\t\t\t<dd>\r\n");
      out.write("\t\t\t\t\t<input readonly=\"readonly\" type=\"text\" name=\"name\" maxlength=\"20\" class=\"required\" value=\"");
      out.print(((UserInfo)request.getSession().getAttribute("LOGIN_USER")).getUsername() );
      out.write("\"/>\r\n");
      out.write("\t\t\t\t\t<span class=\"info\"></span>\r\n");
      out.write("\t\t\t\t</dd>\r\n");
      out.write("\t\t\t</dl>\r\n");
      out.write("\t\t\t<dl>\r\n");
      out.write("\t\t\t\t<dt>公告标题:</dt>\r\n");
      out.write("\t\t\t\t<dd>\r\n");
      out.write("\t\t\t\t\t<input readonly=\"readonly\" type=\"text\" name=\"email\" class=\"required\" value=\"");
      out.print(request.getParameter("ebname"));
      out.write("\" />\r\n");
      out.write("\t\t\t\t\t<span class=\"info\"></span>\r\n");
      out.write("\t\t\t\t</dd>\r\n");
      out.write("\t\t\t</dl>\r\n");
  ...
  private boolean _jspx_meth_s_005fradio_005f0(PageContext _jspx_page_context)
    ...
    // /main/noticejsp/passNoctie.jsp(36,5) name = list type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fradio_005f0.setList("#{1:'通过',2:'不通过'}");
    // /main/noticejsp/passNoctie.jsp(36,5) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fradio_005f0.setName("epass");
    // /main/noticejsp/passNoctie.jsp(36,5) name = cssClass type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
