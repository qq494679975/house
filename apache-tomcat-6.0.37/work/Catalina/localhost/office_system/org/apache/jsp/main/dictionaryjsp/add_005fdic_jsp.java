...
public final class add_005fdic_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\tvar url = \"dictionary/dictionaryCRUD!dicIsOnly.action?_=\"+new Date().getTime()+\"&dfatherid=\"+key;\r\n");
      ...
      out.write("\tvar url = \"dictionary/dictionaryCRUD!dicIsOnly.action?_=\"+new Date().getTime()+\"&dfatherid=\"+remotevalue;\r\n");
      out.write("\taaa.setAttribute(\"remote\",url);\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("\t<form method=\"post\" action=\"dictionary/dictionaryCRUD!addDic\" class=\"pageForm required-validate\" onsubmit=\"return validateCallback(this,navTabAjaxDone)\">\r\n");
      ...
      out.write("\t\t\t\t<dd>\r\n");
      out.write("\t\t\t\t\t<input id=\"aaa\" type=\"text\" class=\"required\" name=\"ddname\" remote=\"dictionary/dictionaryCRUD!dicIsOnly.action?_=");
      out.print(new Date().getTime());
      out.write("&dfatherid=0\"/>\r\n");
      out.write("\t\t\t\t</dd>\r\n");
      out.write("\t\t\t</dl>\r\n");
      out.write("\t\t</div>\r\n");
  ...
  private boolean _jspx_meth_s_005fselect_005f0(PageContext _jspx_page_context)
    ...
    // /main/dictionaryjsp/add_dic.jsp(25,5) name = id type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fselect_005f0.setId("xxxx");
    // /main/dictionaryjsp/add_dic.jsp(25,5) name = onchange type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fselect_005f0.setOnchange("readSelect(this.value)");
    // /main/dictionaryjsp/add_dic.jsp(25,5) name = list type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fselect_005f0.setList("bigdic");
    // /main/dictionaryjsp/add_dic.jsp(25,5) name = headerKey type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fselect_005f0.setHeaderKey("0");
    // /main/dictionaryjsp/add_dic.jsp(25,5) name = headerValue type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fselect_005f0.setHeaderValue("请选择");
    // /main/dictionaryjsp/add_dic.jsp(25,5) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
