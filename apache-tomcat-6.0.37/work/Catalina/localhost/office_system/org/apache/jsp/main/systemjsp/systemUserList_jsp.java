...
public final class systemUserList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<form id=\"pagerForm\" onsubmit=\"return navTabSearch(this);\" action=\"usercrud!queryUser.action\" method=\"post\">\r\n");
      ...
      out.write("\t\t\t<li><a class=\"add\" href=\"usercrud!queryDepartmentAndWord.action\" target=\"navTab\"><span>添加用户</span></a></li>\r\n");
      ...
      out.write("\t\t\t\t<th width=\"80\">账号</th>\r\n");
      out.write("\t\t\t\t<th width=\"100\">真实姓名</th>\r\n");
      out.write("\t\t\t\t<th width=\"30\">性别</th>\r\n");
      out.write("\t\t\t\t<th width=\"150\" align=\"center\">手机</th>\r\n");
      out.write("\t\t\t\t<th>地址</th>\r\n");
      out.write("\t\t\t\t<th width=\"80\">用户状态</th>\r\n");
      out.write("\t\t\t\t<th width=\"80\">修改</th>\r\n");
      out.write("\t\t\t\t<th width=\"80\">冻结/解冻</th>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</thead>\r\n");
      out.write("\t\t<tbody>\r\n");
      out.write("\t\t\t");
  ...
  private boolean _jspx_meth_s_005ftextfield_005f0(PageContext _jspx_page_context)
    ...
    // /main/systemjsp/systemUserList.jsp(14,8) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005ftextfield_005f1(PageContext _jspx_page_context)
    ...
    // /main/systemjsp/systemUserList.jsp(17,8) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005ftextfield_005f1.setName("realname");
  ...
  private boolean _jspx_meth_s_005fselect_005f0(PageContext _jspx_page_context)
    ...
    // /main/systemjsp/systemUserList.jsp(22,4) name = list type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fselect_005f0.setList("%{department}");
    // /main/systemjsp/systemUserList.jsp(22,4) name = headerKey type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fselect_005f0.setHeaderKey("0");
    // /main/systemjsp/systemUserList.jsp(22,4) name = headerValue type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fselect_005f0.setHeaderValue("请选择");
    // /main/systemjsp/systemUserList.jsp(22,4) name = name type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_s_005fiterator_005f0(PageContext _jspx_page_context)
    ...
    // /main/systemjsp/systemUserList.jsp(56,3) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fiterator_005f0.setVar("notice");
    // /main/systemjsp/systemUserList.jsp(56,3) name = value type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fiterator_005f0.setValue("%{pageModel.result}");
    // /main/systemjsp/systemUserList.jsp(56,3) name = status type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_s_005fiterator_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        ...
        out.write("</td>\r\n");
        out.write("\t\t\t\t<td>");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${notice.username}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("</td>\r\n");
        out.write("\t\t\t\t<td>");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${notice.realname}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("</td>\r\n");
        out.write("\t\t\t\t<td>");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${notice.sex==1?\"男\":notice.sex==2?\"女\":\"\"}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("</td>\r\n");
        out.write("\t\t\t\t<td>");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${notice.mbphone}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("</td>\r\n");
        out.write("\t\t\t\t<td>");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${notice.address}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("</td>\r\n");
        out.write("\t\t\t\t<td>");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${notice.status==0?\"正常\":\"冻结\"}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("</td>\r\n");
        out.write("\t\t\t\t<td>\r\n");
        out.write("\t\t\t\t");
  ...
  private boolean _jspx_meth_s_005fif_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /main/systemjsp/systemUserList.jsp(66,4) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fif_005f0.setTest("#notice.userid!=1");
    ...
    if (_jspx_eval_s_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\r\n");
        out.write("\t\t\t\t<a title=\"修改信息\" href=\"usercrud!queryUserById.action?userid=");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${notice.userid}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("\" target=\"navTab\" class=\"btnView\">编辑</a>\r\n");
        out.write("\t\t\t\t<a title=\"删除管理员\" href=\"usercrud!delSystemUser.action?userid=");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${notice.userid}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
  ...
  private boolean _jspx_meth_s_005fif_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_s_005fiterator_005f0, PageContext _jspx_page_context)
    ...
    // /main/systemjsp/systemUserList.jsp(71,4) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_s_005fif_005f1.setTest("#notice.userid!=1");
    ...
    if (_jspx_eval_s_005fif_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      ...
      do {
        out.write("\r\n");
        out.write("\t\t\t\t<a title=\"");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${notice.status==1?'解冻':'冻结'}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("管理员\" href=\"usercrud!lockUser.action?userid=");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${notice.userid}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("&status=");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${notice.status}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("\" target=\"ajaxTodo\" rel=\"noticeedit\" class=\"btnAttach\">");
        out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${notice.status==1?\"解冻\":\"冻结\"}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
        out.write("</a>\r\n");
        out.write("\t\t\t\t");
